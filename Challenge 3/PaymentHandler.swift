...
//  Challenge 3
//
//  Created by Hisham Helwani on 12/19/22.
//
...
class PaymentHandler: NSObject {
    ...
    func shippingMethodCalculator() -> [PKShippingMethod] {
        ...
        if let shippingEnd = shippingEnd, let shippingStart = shippingStart {
            ...
            shippingDelivery.dateComponentsRange = PKDateComponentsRange(start: startComponets, end: endComponents)
            shippingDelivery.detail = "Order sent to address"
    ...
    func startPayments(products: [Product], total: Int, completion: @escaping PaymentCompletionHandler){
        ...
        paymentRequest.merchantIdentifier = "merchant.io.designcode.ontheriseco"
